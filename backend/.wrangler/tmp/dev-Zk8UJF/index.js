  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\Naveen Reddy\\Desktop\\harikirat\\week-13\\medium\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\Naveen Reddy\\Desktop\\harikirat\\week-13\\medium\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// .wrangler/tmp/bundle-7k1Iqj/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-7k1Iqj/middleware-insertion-facade.js
init_modules_watch_stub();
...
userRouter.post("/signin", async (c) => {
  ...
  const token = await sign2({ id: anyuser.id }, c.env.JWT_SECRET);
  return c.json({ token });
});
...
blogRouter.use("/*", async (c, next) => {
  ...
  const user = await verify2(headers, c.env.JWT_SECRET);
  if (user) {
